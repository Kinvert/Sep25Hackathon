...
int main() {
    ...
    env->box_k_growth = 0.382745113745057;

    env->dist_decay = 41.4607043293644;

    env->grip_k_decay = 3.0;
    env->grip_k_max = 13.176817276380092;
    env->grip_k_min = 1.0;

    env->pos_const = 0.6139523971036905;
    env->pos_penalty = 0.0001;

    env->reward_grip = 0.7504388912014437;
    env->reward_ho_drop = 0.2621607720500283;
    env->reward_hover = 0.25189232876140244;

    env->reward_max_dist = 65.0;
    env->reward_min_dist = 1.2574298048547647;

    env->vel_penalty_clamp = 0.45318093362341383;

    env->w_approach = 2.5;
    env->w_position = 0.830661256270675;
    env->w_stability = 0.3268312145336416;
    env->w_velocity = 0.2300285842499415;
